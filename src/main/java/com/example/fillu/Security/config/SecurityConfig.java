package com.example.fillu.Security.config;

import com.example.fillu.Security.services.PersonDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(personDetailsService) //вход
                .passwordEncoder(getPasswordEncoder()); //сравнение хешей
